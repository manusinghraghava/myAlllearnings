...
public class BookDetailsController extends DefaultWidgetController
{
	...
	// The following two attributes are used for creating the popup preview component used in exercise 6
	// More info regarding ZK popups here: https://www.zkoss.org/wiki/ZK_Component_Reference/Essential_Components/Popup
	...
	public void handleSelectedBook(final BookModel book)
	{
		...
		if (book != null)
		{
			populateImgDiv();
			populateInfoDiv();
			// TODO exercise 6.6: move the following call to handleAllowPreview(Boolean) (HINT: take the clearImagePopup() call, too
			populateImagePopup();
		}
	...
	// TODO exercise 6.6: uncomment and complete the implementation of handleAllowPreview.
	/*
	 * public void handleAllowPreview(...){
	 *
	 * }
	 */
	...
	// TODO exercise 6.10: uncomment and complete the implementation of handleObjectsUpdatedEvent()
	/*
	 * public void handleObjectsUpdatedEvent(...){
	 *
	 * }
	 */
	...
	/*
	 * public void handleObjectsDeletedEvent(...){
	 *
	 * }
	 */
	...
	/**
	 * Creates a ZK popup component (containing a larger product photo). Assigns the popup to the existing thumbnail image.
	 * When the thumbnail is clicked, its large-photo popup will appear.
	 */
	private void populateImagePopup()
	{
		this.imgDiv.setPopup(bookImagePopup.getId() + ", position=" + IMAGE_POPUP_POSITION);
